...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.php" class="logoo-link"></a></h1>
</div>
<!--close-Header-part--> 
...
<div id="sidebar"><a href="beranda.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  ...
  ?>
    ...
    <li> <a href="entri_order.php"><i class="icon icon-shopping-cart"></i> <span>Riwayat Pembelian</span></a> </li>
    <li> <a href="entri_transaksi.php"><i class="icon icon-inbox"></i> <span>Riwayat Transaksi</span></a> </li>
    <li> <a href="generate_laporan.php"><i class="icon icon-print"></i> <span>Laporan Stok</span></a> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="beranda.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>Dashboard</a></div>
              ...
              <div class="widget-box">
                <div class="widget-content nopadding">
                  <ul class="site-stats quick-actions">
                    <li class="bg_dg2"><i class="icon-user"></i> <strong><?php echo $result_adm['jumlah_adm']; ?></strong> <small>Administrator</small></li>
                    <li class="bg_g"><i class="icon-user"></i> <strong><?php echo $result_ksr['jumlah_ksr']; ?></strong> <small>Total Kasir</small></li>
                    <li class="bg_lg1"><i class="icon-user"></i> <strong><?php echo $result_own['jumlah_own']; ?></strong> <small>Total Owner</small></li>
                  </ul>
                </div>
              </div>
            </div>
...
<!-- Kode JavaScript untuk grafik -->
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
<script type="text/javascript">
  // Data contoh untuk grafik (ganti ini dengan data Anda yang sesungguhnya)
  var pieChartData = {
    labels: ['Administrator', 'Kasir', 'Owner'],
    datasets: [{
      data: [<?php echo $result_adm['jumlah_adm']; ?>, <?php echo $result_ksr['jumlah_ksr']; ?>, <?php echo $result_own['jumlah_own']; ?>],
      backgroundColor: ['red', 'green', 'blue'],
    }]
  };

  var lineChartData = {
    labels: ['Label1', 'Label2', 'Label3', 'Label4', 'Label5'], // Ganti dengan label sesuai data Anda
    datasets: [{
      label: 'Dataset Label',
      borderColor: 'blue',
      fill: false,
      data: [10, 20, 15, 25, 30], // Ganti dengan data sesuai data Anda
    }]
  };
...
<!--grafikkk-->
      ...
      <div class="alert alert-orange alert-block">
        <center>
          ...
          Di Aplikasi Bakso Kabut Bu Juhairiyah.
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; Bakso Kabut <a href="#">by Bu Juhairiyah</a> </div>
</div>
